...
**Git for Scientists** is a four-hour, hands-on workshop, taught in person; the delivery mechanics (a done-signal, handouts, the regroup rhythm) have a video-call variant so remote participants can follow along (@sec-run-of-show). It teaches researchers the foundations of Git and GitHub, with collaboration as the central theme. Learners leave able to create and clone repositories, work through a Git cycle (pull, stage, commit, push), use branches, and open and merge a pull request.
