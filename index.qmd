...
This handbook covers **Workshop 1: Git and GitHub foundations**. A follow-up workshop on agentic coding for collaboration and scientific work exists as a separate effort. It is mentioned only in one respect: building confidence with the terminology of Git and GitHub for collaboration is what lets a researcher later use agentic AI tools to interact with the technology more confidently. Everything else here is about the foundations workshop.