...
The main (TODO: do not use the term master. Add to my Claude profile) list of planned drawings is collected in @sec-appendix-drawings so you can see them in one place. The detail for each lives here.
...
TODO: Open an issue on this website for the drawings with sub-issues for each of the four drawings.
